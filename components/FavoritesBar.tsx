...
const FavoritesBar: React.FC<FavoritesBarProps> = ({ favorites, onAdd }) => {
        ...
        {favorites.map((fav) => (
          ...
          >
            <div className="flex items-center gap-3 pl-3 pr-4 py-2.5 glass rounded-2xl border border-white/5 hover:border-purple-500/30 hover:bg-white/10 transition-all duration-300">
              ...
              <div className="w-5 h-5 rounded-full bg-purple-500/10 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
